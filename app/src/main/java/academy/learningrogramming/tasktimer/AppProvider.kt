...
/**
 * Provider for the TaskTimer app. This is the only class that knows abput [AppDatabase]
 */

private const val TAG = "AppProvider"

const val CONTENT_AUTHORITY = "academy.learningprogramming.tasktimer.provider"
    ...
    override fun query(uri: Uri, projection: Array<out String>?, selection: String?, selectionArgs: Array<out String>?,
        ...
        when (match) {
            ...
            TASKS_ID -> {
                ...
                queryBuilder.appendWhere("${TasksContract.Columns.ID} = $taskId")       // <-- change method
            }
